...
function(add_ops_info_target)
  ...
  # ARGN: TARGET;ops_info_gen_ascend910b;
  # OUTPUT;/home/maijianqiang/NLLLoss/build_out/op_kernel/tbe/op_info_cfg/ai_core/ascend910b/aic-ascend910b-ops-info.json;
  # OPS_INFO;/home/maijianqiang/NLLLoss/build_out/autogen/aic-ascend910b-ops-info.ini;
  # INSTALL_DIR;packages/vendors/customize/op_impl/ai_core/tbe/config/ascend910b
  # opinfo_file_path:
  # ASCEND_PYTHON_EXECUTABLE: python3
  # OPINFO_OUTPUT:
  # OPINFO_OPS_INFO:
  # OPINFO_OUTPUT:
  cmake_parse_arguments(OPINFO "" "TARGET;OPS_INFO;OUTPUT;INSTALL_DIR" "" ${ARGN})  # 解析传进来的参数
...
function(add_bin_compile_target)
  ...
  foreach(bin_script ${bin_scripts})
    ...
    add_custom_target(${BINCMP_TARGET}_${op_file}_${op_index}
                      COMMAND export HI_PYTHON=${ASCEND_PYTHON_EXECUTABLE} && bash ${bin_script} ${BINCMP_OUT_DIR}/src/${op_type}.py ${BINCMP_OUT_DIR}/bin/${op_file} $(MAKE)
